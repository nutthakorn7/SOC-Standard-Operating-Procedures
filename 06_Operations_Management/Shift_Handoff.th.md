...
| **วันทำงาน/หยุด** | 5 วัน / 2 วัน | 4 วัน / 4 วัน |
...
#### การจัดการความเหนื่อยล้า (กะ 12 ชั่วโมง)
...
| **เปลี่ยนกะกลางคืน→กลางวัน** | หยุดอย่างน้อย 4 วันก่อนเปลี่ยนจากกะคืนเป็นกะวัน |
| **จำกัดภาระงาน** | สูงสุด 25 alerts ต่อ analyst ต่อกะ 12 ชม. |

### 1.3 รูปแบบการให้บริการ
